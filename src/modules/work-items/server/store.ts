...
import type { TablesInsert, TablesUpdate } from '@/generated/supabase/types'
...
export async function listWorkItemsFromStore(
...
export async function getWorkItemFromStore(
  supabase: SupabaseServerClient,
  id: string
): Promise<WorkItem> {
...
export async function createWorkItemInStore(
  supabase: SupabaseServerClient,
  userId: string,
...
export async function updateWorkItemInStore(
  supabase: SupabaseServerClient,
  id: string,
...
async function updateWorkItemStatusInStore(
  supabase: SupabaseServerClient,
  id: string,
...
export function archiveWorkItemInStore(supabase: SupabaseServerClient, id: string) {
  return updateWorkItemStatusInStore(supabase, id, 'archived')
}

export function restoreWorkItemInStore(supabase: SupabaseServerClient, id: string) {
  return updateWorkItemStatusInStore(supabase, id, 'active')
}
