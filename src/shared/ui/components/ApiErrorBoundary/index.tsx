...
import { UnauthorizedError, isApiError } from '@/shared/kernel/errors/api-error'
import { presentError } from '@/shared/ui/errors/presentation'
import { useCountdown } from '@/shared/ui/hooks/use-countdown'
 ...
 * Keep the fallback as a direct component because:
