...
import dayjs from '@/shared/ui/formatters/dayjs'
import type { Locale as I18nLocale, Messages } from '@/shared/ui/i18n'
import { LOCALE_COOKIE_NAME, LOCALE_STORAGE_KEY } from '@/shared/ui/i18n/constants'
import { loadFromStorage, saveToStorage } from '@/shared/ui/storage'

export type { Locale } from '@/shared/ui/i18n'
...
type LocaleProviderProps = {
  ...
  loadMessages?: (locale: I18nLocale) => Promise<Messages>
}
